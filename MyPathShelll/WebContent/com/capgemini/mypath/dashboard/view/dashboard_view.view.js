...
var sogImgCell = new sap.ui.commons.layout.MatrixLayoutCell({
	content : [imageSog]
		...
		var capsogLayout = new sap.ui.commons.layout.HorizontalLayout({
			content:[imageCap , imageSog]
		});//.addStyleClass("tp_namelayout");
		
		this.addContent(capsogLayout);
