jQuery.sap.declare("com.capgemini.mypath.performancereview.commons.MyPathDocumentsStatusMatrix");

/*//CONSTRUCTOR
com.capgemini.mypath.performancereview.commons.MyPathDocumentsStatusMatrix = function(options) {
...
com.capgemini.mypath.performancereview.commons.MyPathDocumentsStatusMatrix = {
		...
		readJSON : function(documentFor, documentType, substatus) {
			...
			var url = performancereview_ns.url_app + "com/capgemini/mypath/performancereview/model/MyPath_Substatus.json";
			//Ajax Call   
			jQuery.ajax({
				url : url,
				...
				success : function(data, textStatus, jqXHR) {
					...
					if (documentFor === performancereviewContext.oBundle.getText("EMPLOYEE")) {
