	...
	*/ 
	createContent : function(oController) {
		...
		var pipButton = new sap.m.Button({
			 type : "Emphasized",
		     icon : "sap-icon://add",
		     visible : true , //myPathContext.system=="ECD" || myPathContext.system=="ECQ"?true:false, 		CREATE_PIP 
		     text: myPathContext.i18nModel.getProperty("CREATE_PIP"),
			press : function()
			{
		...
		}).addStyleClass("mypath_add_button_style").addStyleClass("mgrdash_create_pip_btn");
		...
		}).addStyleClass("mgrdash_list_header_text");
		...
		var pipButtonLayout = new sap.ui.commons.layout.HorizontalLayout({
			content:[pipButton]
		}).addStyleClass("mgrdash_list_header_textPIP");
		
		/*var perHlayout = new sap.ui.commons.layout.HorizontalLayout({
			content:[headerLayout,
			         pipButtonLayout , 
			         ]
		}).addStyleClass("mgrdash_list_header_HL");*/
		
		var perHlayout = new sap.ui.commons.layout.MatrixLayout({
			//id : "matrix1",
			layoutFixed : false,
			widths : ['85%' , '27%'],
		}).addStyleClass("mgrdash_list_header_HL");
		perHlayout.createRow( headerLayout, pipButtonLayout );	
