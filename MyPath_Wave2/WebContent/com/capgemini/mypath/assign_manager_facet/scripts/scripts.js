...
asAssignManagerContext.applyFilter = function() {
	...
	for (var i = 0; i < asAssignManagerContext.totalSelectedButtonsArray.length; i++) {
		...
		if (filter_button.getHeader().toUpperCase() == myPathContext.i18nModel.getProperty("SUB_STATUS")) {
		...
		else if (filter_button.getHeader().toUpperCase() == myPathContext.i18nModel.getProperty("ACTION_CAP")) {
